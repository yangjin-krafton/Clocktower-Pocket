...
게임 시작 시 ![](../asset/editions/tb-outsider.png) **아웃사이더 토큰 2개**가 추가되고,
대신 ![](../asset/editions/tb-townsfolk.png) **마을 주민 토큰 2개**가 제거된다.
...
- ![](../asset/icons/drunk.png) 주정뱅이가 추가되는 경우, 주정뱅이의 별도 셋업 규칙도 따릅니다.
...
- ![](../asset/icons/butler.png) **집사**: 주인이 투표하지 않으면 투표 불가 — 투표권 제약
- ![](../asset/icons/drunk.png) **주정뱅이**: 자신이 주정뱅이인지 모른 채 능력이 오작동
- ![](../asset/icons/recluse.png) **은둔자**: 악 팀이나 임프로 등록될 수 있어 조사를 왜곡
- ![](../asset/icons/saint.png) **성자**: 처형당하면 **선 팀 즉시 패배** — 매우 위험
...
4. **성자 처형 유도**: ![](../asset/icons/saint.png) 성자가 있다면 처형하도록 유도하세요 — 선 팀 즉시 패배!
...
- ![](../asset/icons/librarian.png) 사서가 아웃사이더를 확인하면 남작을 추론할 수 있습니다.
...
2. **정보 역할 활용**:
   - ![](../asset/icons/librarian.png) **사서**: 아웃사이더를 직접 확인
   - ![](../asset/icons/investigator.png) **조사관**: 미니언을 조사하면 남작을 특정할 수 있음
   - ![](../asset/icons/ravenkeeper.png) **까마귀 사육사**: 죽을 때 역할 확인
   - ![](../asset/icons/undertaker.png) **장의사**: 처형자 역할 확인
3. **다른 미니언 부재 확인**: 남작이 있으면 ![](../asset/icons/poisoner.png) 독살자, ![](../asset/icons/spy.png) 스파이, ![](../asset/icons/scarletwoman.png) 진홍의 여인이 적습니다 (미니언 슬롯을 남작이 차지하므로).

### 남작 대응 전략

1. **아웃사이더 보호**: 아웃사이더의 주장이 신뢰할 만하면 살려두세요 — 확인된 선 팀입니다.
2. **의심스러우면 빠르게 제거**: 남작이 있는지 불확실하면, 아웃사이더를 사칭하는 플레이어를 빠르게 처형하는 것도 방법입니다.
3. **주정뱅이 탐색**: 아웃사이더 수가 정확히 맞지 않으면 ![](../asset/icons/drunk.png) 주정뱅이가 숨어있을 수 있습니다.
...
- ![](../asset/icons/empath.png) **공감인**: 거짓 숫자로 선 팀의 추리를 방해
- ![](../asset/icons/chef.png) **요리사**: 악 쌍 수 정보로 신뢰 획득 후 오도
- ![](../asset/icons/undertaker.png) **장의사**: 처형 결과를 거짓으로 보고
- ![](../asset/icons/monk.png) **수도사**: "보호했는데 아무도 안 죽었다"로 위장
- ![](../asset/icons/butler.png) **집사** / ![](../asset/icons/recluse.png) **은둔자**: 아웃사이더로 위장
...
| 역할 | 상호작용 |
|---|---|
| ![](../asset/icons/librarian.png) **사서** | 아웃사이더 수 증가를 통해 남작 존재를 추론 가능 |
| ![](../asset/icons/investigator.png) **조사관** | 남작을 미니언으로 직접 탐지 가능 |
| ![](../asset/icons/drunk.png) **주정뱅이** | 남작이 추가한 아웃사이더에 포함될 수 있음 (별도 셋업 규칙 적용) |
| ![](../asset/icons/saint.png) **성자** | 남작이 추가한 성자가 처형되면 선 팀 즉시 패배 |
| ![](../asset/icons/recluse.png) **은둔자** | 조사 왜곡으로 남작 탐지를 방해 |
| ![](../asset/icons/imp.png) **임프** | 자결(Starpass) 시 남작이 새 임프로 승계 가능 |
| ![](../asset/icons/poisoner.png) **독살자** | 남작이 미니언 슬롯을 차지하므로 독살자가 없을 가능성 |
| ![](../asset/icons/scarletwoman.png) **진홍의 여인** | 같은 이유로 진홍의 여인이 없을 가능성 |
