...
2. **다른 정보 역할과 교차 검증**: ![](../asset/icons/empath.png) 공감인, ![](../asset/icons/fortuneteller.png) 점쟁이의 정보와 합치면 악 팀 위치를 크게 좁힐 수 있습니다.
...
- ![](../asset/icons/spy.png) **스파이**가 선으로 등록되면 쌍 수가 실제보다 **줄어듭니다**.
- ![](../asset/icons/recluse.png) **은둔자**가 악으로 등록되면 쌍 수가 **늘어납니다**.
...
| 역할 | 상호작용 |
|---|---|
| ![](../asset/icons/spy.png) **스파이** | 선으로 등록되면 이웃 쌍 수 감소 (이야기꾼 재량) |
| ![](../asset/icons/recluse.png) **은둔자** | 악으로 등록되면 이웃 쌍 수 증가 (이야기꾼 재량) |
| ![](../asset/icons/drunk.png) **주정뱅이** | 요리사가 실제로 주정뱅이라면 잘못된 숫자를 받음 |
| ![](../asset/icons/poisoner.png) **독살자** | 첫째 밤에 중독되면 잘못된 숫자를 받음 |
| ![](../asset/icons/empath.png) **공감인** | 양옆 악 수 정보와 교차 확인 가능 — 매우 강력한 조합 |
| ![](../asset/icons/investigator.png) **조사관** | 미니언 위치 정보와 조합하면 악 팀 좌석 특정 가능 |
| ![](../asset/icons/baron.png) **남작** | 남작 자체는 쌍 수에 영향 없음 (미니언이므로 악 팀으로 집계) |
