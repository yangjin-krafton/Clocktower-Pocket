...
- **임프 찾기**: 매일 밤 의심스러운 사람들을 조사하세요.
- **오탐 식별**: 누가 Red Herring인지 찾아내세요.
- **범위 좁히기**: 여러 밤에 걸쳐 임프 후보를 줄이세요.

### Red Herring (오탐)

- **고정됨**: 게임 시작 시 1명이 정해지고 **바뀌지 않습니다**.
- **선 팀**: 오탐은 항상 **선 팀** 플레이어입니다.
- **임프처럼 보임**: 그 사람과 조사하면 "예스"가 나옵니다.
...
1. **교차 조사**: 같은 사람을 여러 조합으로 조사해 오탐을 찾으세요.
   - A+B = 예스, A+C = 예스 → A가 오탐 or 임프
   - B+C = 아니오 → A가 오탐 확정
2. **정보 기록**: 매일 조사 결과를 메모하세요.
3. **처형 전 조사**: 의심가는 사람을 처형 전날 밤 조사하세요.
4. **블러프 대비**: 악 팀도 점술사를 사칭할 수 있으니 구체적으로 설명하세요.
