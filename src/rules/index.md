...
3. 셋업 능력이 있는 역할을 먼저 처리합니다:
   - ![](../asset/icons/baron.png) **남작**: 마을 주민 -2, 아웃사이더 +2
   - ![](../asset/icons/drunk.png) **주정뱅이**: 마을 주민 토큰 1개를 주정뱅이로 표시 (본인은 해당 마을 주민이라고 믿음)
...
| 임프가 처형됨 | **선 팀** 승리 |
| 생존자 2명 이하 | **악 팀** 승리 |
| ![](../asset/icons/saint.png) 성자가 처형됨 | **악 팀** 승리 |
| ![](../asset/icons/mayor.png) 시장 + 생존자 3명 + 처형 없는 낮 | **선 팀** 승리 |
