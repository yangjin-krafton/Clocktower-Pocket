...
**매일 밤**, 자신 제외 1명을 보호해, 그 밤 **데몬 공격**으로부터 지킨다.
...
- **예측**: 데몬이 누구를 공격할지 예상하세요.
- **정보 활용**: 보호 성공 시 데몬의 타겟을 알 수 있습니다.

### 보호 규칙

- **데몬 공격만 막음**: 처형이나 ![](../asset/icons/slayer.png) 학살자 능력은 막지 못합니다.
...
- ![](../asset/icons/soldier.png) **병사**: 이미 면역인 병사를 보호할 필요는 없습니다.
...
4. **보호 성공 추론**: 누군가 계속 살아있다면 당신이 보호했거나 데몬이 피한 것입니다.
...
- ![](../asset/icons/soldier.png) **병사**: 이미 면역이므로 보호 불필요.
