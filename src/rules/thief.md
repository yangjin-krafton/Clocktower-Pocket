# ![](../asset/icons/thief.png) 도둑 (Thief)
...
매일 밤 자신이 아닌 플레이어 1명을 선택합니다. 다음 날 그 플레이어의 투표는 **-1표**로 계산됩니다.
...
- 추방은 능력 영향을 받지 않으므로, 추방 지지에는 -1표가 적용되지 않습니다.
...
- **추방**: 추방 지지에는 영향을 주지 않습니다.
- ![](../asset/icons/undertaker.png) **장의사**: 도둑 능력은 처형 대상을 바꿀 수 있지만, 스스로 죽이지는 않습니다.
